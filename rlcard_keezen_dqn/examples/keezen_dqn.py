...
log_dir = 'experiments/keezen_dqn_result_58/'
...
with tf.Session() as sess:
    ...
    env.set_agents([dqn_agent1, random_agent1, dqn_agent1, random_agent3])
    eval_env.set_agents([dqn_agent1, random_agent1, dqn_agent1, random_agent3])
