...
print("Load model")
# Pretrained model
check_point_path = os.path.join(rlcard.__path__[0], 'models/pretrained/keezen_dqn49')
...
while not env.is_over():
    ...
    cardsPlayer0 = env.game.game_state.player_cards[env.game.players[0]]
    fours = [card for card in cardsPlayer0 if card.card_value == CardValue.FOUR]
    if len(fours) > 0 or val == "":
